  ...
  $.getJSON("./test.json", null, function(data) {
    for(var i = 0; i < data.length; i++){
      if(data[i].service === "twitter"){
        appendTwitter(data[i].service, data[i].user, data[i].message, data[i].time, i, data[i].img_url, data[i].user_icon, data[i].post_url);
      }else if(data[i].service === "facebook"){
        appendFacebook(data[i].service, data[i].user, data[i].message, data[i].time, i, data[i].img_url, data[i].user_icon, data[i].post_url);
      }else if(data[i].service === "line"){
        appendLine(data[i].service, data[i].user, data[i].message, data[i].time, i, data[i].img_url, data[i].user_icon, data[i].post_url);
      }else{
      }
    }
  })
